//! OpenTelemetry Gauge Metrics Schema
//!
//! Gauge metrics stored in ClickHouse.
...
/// Table abstraction for OtelMetricGauge
#[derive(Injectable, lily_clickhouse_derive::ClickhouseTable, Default)]
#[entity_type(OtelMetricGauge)]
#[service(lifetime = "Singleton")]
pub struct OtelMetricGaugeTable {
    #[inject]
    pub db: Arc<DatabaseService>,
}

/// Repository for OtelMetricGauge CRUD operations
#[derive(Injectable, lily_clickhouse_derive::ClickhouseRepository, Default)]
#[table_type(OtelMetricGaugeTable)]
#[entity_type(OtelMetricGauge)]
#[service(lifetime = "Singleton")]
pub struct OtelMetricGaugeRepository {
    #[inject]
    pub table: Arc<OtelMetricGaugeTable>,
}
